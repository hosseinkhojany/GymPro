...
public class FButtonFarsi extends AppCompatButton implements View.OnTouchListener {
    ...
    public FButtonFarsi(Context context) {
        super(context);
        init();
    ...
    public FButtonFarsi(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    ...
    public FButtonFarsi(Context context, AttributeSet attrs, int defStyle) {
